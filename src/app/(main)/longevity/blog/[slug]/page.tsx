    ...
    <>
      ...
      <article className="py-12 sm:py-20">
        <div className="container mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          {/* Back */}
          <Button variant="ghost" size="sm" nativeButton={false} render={<Link href="/longevity/blog" />} className="mb-8 -ml-2 gap-2">
          ...
          {/* CTA */}
          <div className="rounded-xl bg-primary/5 dark:bg-primary/10 border border-primary/10 dark:border-primary/20 p-8 text-center">
            ...
            <Button nativeButton={false} render={<Link href="/longevity/demo" />} className="mt-4">
              Book a Demo
            </Button>
          </div>
        </div>
